      ...
      {items.map((item, idx) => (
        <a
          ...
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
              className="absolute inset-0 h-full w-full rounded-full bg-[var(--surface2)]" />
          )}
...
export const MobileNavToggle = ({
  ...
  return isOpen ? (
    <X className="text-[var(--text)]" onClick={onClick} />
  ) : (
    <Menu className="text-[var(--text)]" onClick={onClick} />
  );
};
