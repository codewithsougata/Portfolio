...
export const GlobeSection = memo(function GlobeSection() {
  return (
    <div
      className="flex flex-row items-center justify-center py-20 h-screen md:h-auto bg-transparent relative w-full overflow-hidden">
      <div
        ...
        <motion.div
          ...
          <p
            ...
            Available for remote work across the globe. Let&apos;s build something amazing together.
          </p>
        </motion.div>

        {/* Changed background gradients to be transparent/adaptive */}
        <div
